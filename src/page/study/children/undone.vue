  ...
  <div class="undone">
    ...
    <div class="timeline">
      ...
      <div class="timeline-main">
        <div class="line-list">
          <ul class="flex">
            <li class="item-column" v-for="(item,index) in items" :key="index"
                :style="{ marginLeft: cHeight + 'px', marginRight: cHeight + 'px' }">
              <div class="column" :style="{height: item[0]+ 'px' }"></div>
              <div class="round" @click="getDialogInfo(index)" :style="{ top: (-item[0] - 10 - jumpRound) + 'px' }"
                   :class="dataIndex==index?'animate':''"></div>
        ...
        <div class="day-list">
          <ul class="flex">
            <li class="list-item" v-for="(item, index) in items" :key="item.index"
                :style="{ marginLeft: cHeight + 'px', marginRight: cHeight + 'px' }">
