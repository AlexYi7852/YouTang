    ...
    <div class="child-box">
      <div class="child-head">
        <div class="child-avatar">
          <VueImgInputer v-model="picValue" theme="material" size="small" :imgSrc="msg.headurl"></VueImgInputer>
        </div>
        <div class="child-name">
          <input type="text" class="cname" v-model="msg.name" placeholder="名字" maxlength="4">
        </div>
      </div>
      <div class="child-form">
        ...
        <div class="sex section">
          <div class="info-input clearfix">
            ...
            <el-radio-group class="fl-r" v-model="msg.sex">
        ...
        <div class="ages section">
          <div class="info-date clearfix">
            ...
            <el-input class="fl-r" v-model="msg.ages" type="text" maxlength="2"></el-input>
          </div>
        </div>
        <!-- reward -->
  ...
  export default {
    ...
    methods: {
      ...
      saveChildInfo() {
        ...
        formData.append('sex', this.msg.sex);
        formData.append('ages', this.msg.ages);
